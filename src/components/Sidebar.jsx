	...
	return (
		...
		>
			<div className="relative w-full flex justify-end">
				<span onClick={() => setSidebarOpened(!sidebarOpened)} className={`${sidebarOpened ? 'right-3' : 'right-5 rotate-180'}  material-icons absolute transition select-none cursor-pointer active:scale-90 top-3 dark:text-white dark:bg-gray-800 rounded`}>
					menu_open
				</span>
			</div>
			...
			<div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
				<div className={`${!sidebarOpened ? 'items-end' : ''} flex flex-col space-y-2 font-medium h-full`}>
					...
					<NavLink
						to="/"
						className={({ isActive }) => `${isActive && 'bg-gray-100 dark:bg-gray-700 '} flex transition active:scale-95 select-none items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 active:bg-gray-300 dark:hover:bg-gray-700 dark:active:bg-gray-600 group mt-auto mb-4`}
					>
